...
import {
  Center, Text, Stack, Box, Heading, Badge, 
} from '@chakra-ui/react'
import {FaCocktail,FaHiking,FaSwimmingPool,FaCoffee} from 'react-icons/fa'
...
export default function Services() {
  return (
    ...
    <Center>            
    <Stack direction={['column','row']} mr={'2'}ml={'2'} mt={[16, 12, 0]}>
                    ...
                    <Box
                      ...
                      _hover={{
                        cursor:'pointer'
                          ...
                          <Center mt={7} mb={2}>   
                              <Text fontSize='5xl' color={'primary'}>{service.icon}</Text>
                          </Center>
                        <Box p='6'>    
                          <Center>
                          <Box
